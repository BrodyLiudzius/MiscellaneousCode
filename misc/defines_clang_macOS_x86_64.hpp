// Defines generated by the Clang compiler targeting an x86_64 MacOS device
// Generated by Clang via the command `clang++ -E -dM defines_clang_macOS_x86_64.hpp`

//        OS:  macOS 11.4 Big Sur
//  Compiler:  clang 12.0.5 (clang-1205.0.22.11)
