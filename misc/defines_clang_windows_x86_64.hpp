// Defines provided by the Clang compiler targeting an x86_64 Windows 11 device
// Generated by Clang via the command `clang -E -dM defines_clang_windows_x86_64.hpp`
...
#define __VERSION__ "Clang 20.1.4"
...
#define __clang_version__ "20.1.4 "
